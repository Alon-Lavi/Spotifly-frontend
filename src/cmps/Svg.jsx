export const Svg = {
	...
	shuffleInactive: (
		<svg
			...
			aria-hidden="true"
			viewBox="0 0 16 16"
			className={`shuffle-song inactive }`}
		>
			<path d="M13.151.922a.75.75 0 10-1.06 1.06L13.109 3H11.16a3.75 3.75 0 00-2.873 1.34l-6.173 7.356A2.25 2.25 0 01.39 12.5H0V14h.391a3.75 3.75 0 002.873-1.34l6.173-7.356a2.25 2.25 0 011.724-.804h1.947l-1.017 1.018a.75.75 0 001.06 1.06L15.98 3.75 13.15.922zM.391 3.5H0V2h.391c1.109 0 2.16.49 2.873 1.34L4.89 5.277l-.979 1.167-1.796-2.14A2.25 2.25 0 00.39 3.5z" />
			<path d="M7.5 10.723l.98-1.167.957 1.14a2.25 2.25 0 001.724.804h1.947l-1.017-1.018a.75.75 0 111.06-1.06l2.829 2.828-2.829 2.828a.75.75 0 11-1.06-1.06L13.109 13H11.16a3.75 3.75 0 01-2.873-1.34l-.787-.938z" />
		</svg>
	...
	repeatActive: (
		<svg
			...
			aria-hidden="true"
			viewBox="0 0 16 16"
			className={`repeat-on-icon 'active' uPxdw loop-song`}
		>
	...
	activeHome: (
		<svg
			...
			viewBox="0 0 24 24"
			data-encore-id="icon"
			style={{ fill: 'white', marginRight: '15px', marginBottom: '-15px' }}
		>
	...
	activeSearch: (
		<svg
			...
			viewBox="0 0 24 24"
			data-encore-id="icon"
			style={{ fill: 'white', marginRight: '15px', marginTop: '17px', marginLeft: '1px' }}
		>
	...
	removeFromLibrary: (
		<svg
			...
			style={{ fill: '#1ed760' }}
			viewBox="0 0 16 16"
			className="Svg-sc-ytk21e-0 kAkpoF"
		>
	...
	chanIcon: (
		<svg xmlns="http://www.w3.org/2000/svg" width="11px" height="11px" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16">
			{' '}
