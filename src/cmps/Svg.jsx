export const Svg = {
	...
	homeIcon: (
		<svg
			...
			viewBox="0 0 24 24"
			style={{ fill: 'gray', marginRight: '15px', marginBottom: '-15px' }}
			data-encore-id="icon"
		>
	...
	searchHomePageIcon: (
		<svg
			...
			viewBox="0 0 24 24"
			data-encore-id="icon"
			style={{ fill: 'gray', marginRight: '15px', marginTop: '17px', marginLeft: '1px' }}
		>
...
// heartIcon: (
// 	<svg className="heart-icon" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
