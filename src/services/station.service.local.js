...
var stationsDemo = [
...

	{
		...
		createdBy: {
			...
			fullname: 'Puki Ben David',
			imgUrl:
				"https://seeded-session-images.scdn.co/v1/img/artist/5tHvjw07aaiv3mZ6qJdKzb/en"
		},
		likedByUsers: ['{minimal-user}', '{minimal-user}'],
...

	{
		...
		createdBy: {
			...
			fullname: 'Puki Ben David',
			imgUrl:
				"https://i.scdn.co/image/ab67706f00000002d1e67ca86b9727635bd5bc69"
		},
		likedByUsers: ['{minimal-user}', '{minimal-user}'],
...

	{
		...
		createdBy: {
			...
			fullname: 'Puki Ben David',
			imgUrl:
				"https://i.scdn.co/image/ab67616d00001e022ab6f137693d0fcf542ecbe2"
		},
		likedByUsers: ['{minimal-user}', '{minimal-user}'],
...
async function createStations() {
	...
	if (!stationsFromStorage || !stationsFromStorage.length) {
		storageService._save(STORAGE_KEY, stationsDemo)
	}
...
storageService._save(GENRE_KEY, genres)
...
// TEST DATA
// storageService.post(STORAGE_KEY, {vendor: 'Subali Rahok 2', : 980}).then(x => console.log(x))
